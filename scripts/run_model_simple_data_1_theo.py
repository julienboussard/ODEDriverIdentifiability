...
OUTPUT_ROOT = PROJECT_ROOT / "output" / "ode_sparse_discovery_theo" / "simple"
...
if __name__ == "__main__":
    ...
    for noise in [0.00, 0.50, 1.00, 1.50, 2.00]:
        for confounder in [False, True]:
            ...
            data_dir_noise = DATA_ROOT / f"noise={noise:.2f}_confounder={confounder}" / "data"
            eval_dir_noise = OUTPUT_ROOT / f"noise={noise:.2f}_confounder={confounder}" / model_name
